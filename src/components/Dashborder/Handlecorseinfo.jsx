...
export default function Handlecorseinfo({ data, render }) {
  ...
  useEffect(() => {
    ...
    if (data.mood === "edit") {
      ...
      setSelectedInstructors(map(instructors, "_id"));
      setBenifit(benifits), setBenifitInput(benifits.join("\n")), setimg();
    } else {
      setimg();
      setBenifit([]);
            ...
            <img
              ...
              src={
                img
                  ...
                  : thumbnail
                  ? thumbnail
                  : "https://i.ibb.co/6BGt0LL/summer-internship.webp"
              }
              alt=""
            />
          </div>
              ...
              >
                <div className="form-control">
                  <label className="label">
                    <span className="text-lg ">Course Banner</span>
                  </label>
                  <input
                    name="thumbnail"
                    onChange={handleimg}
                ...
                <div className="form-control">
                  <label className="label">
                    <span className="text-lg ">Course Categorey</span>
                  </label>
                  <select
                    onChange={handleInput}
                    name="category"
                    ...
                    <div className="form-control">
                      <label className="label">
                        <span className="text-lg ">
                          Select Instructors for this course (You can select Multiple)
                        </span>
                      </label>
                      <select
                          ...
                          .map((ele) => {
                            return (
                              <div key={ele._id} className="flex gap-4">
                                <img className="h-14" src={ele.avatar} alt="" />
                ...
                <div className="benifits grid grid-cols-2 gap-5">
                  <div className="form-control flex-1">
                    <label className="label">
                      <span className="text-lg ">
                        Write benifits and Hit Enter To create New Line
                      </span>
                    </label>
                    <textarea
                ...
                <div className="form-control mt-6">
                  <input
                    type="submit"
                    value={data.mood === "add" ? " Publish Now" : "Update Now"}
